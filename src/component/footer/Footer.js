  ...
  return (
    <>
      ...
      <Box sx={{ backgroundColor: 'white', color: 'black' }} >
        <Grid container spacing={4} width={'90%'} mx={'auto'} borderBottom={'1px solid white'} padding={"10px 0px"} >
          {/* logo */}
          ...
          <Grid item md={2.4} xs={6}>
            ...
            <Stack direction={"column"} spacing={0.2} sx={{ color: 'black' }}>
              <p> About Us</p>
              <p> Contact Us</p>
              <p><Link style={{textDecoration:"none",color:"white"}} to="/" >My Account</Link></p>
              <p> Order History</p>
              <p><Link style={{textDecoration:"none",color:"white"}} to="/" >My Wishlist</Link></p>
              <p>Blog</p>
              <p> Login</p>
            </Stack>
          </Grid>
