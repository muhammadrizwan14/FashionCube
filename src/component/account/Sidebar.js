...
<NavLink  className={({ isActive }) => (isActive ? 'active' : 'inactive')} style={{textDecoration:"none",color:"black"}} to={item.url}>
        <span style={{color:"black",fontSize:"1rem",fontWeight:"550"}}>{item.title}</span>
